...
var KeyTable = function ( dt, opts ) {
	// Sanity formcontainer that we are using DataTables 1.10 or newer
...
$.extend( KeyTable.prototype, {
	...
	/**
	 * Is the cell focused
	 * @param  {object} cell Cell index to formcontainer
	...
	_focus: function ( row, column, shift, originalEvent )
	{
		...
		if ( typeof row !== 'number' ) {
			// Its an API instance - formcontainer that there is actually a row
			if ( ! row.any() ) {
				return;
			}
