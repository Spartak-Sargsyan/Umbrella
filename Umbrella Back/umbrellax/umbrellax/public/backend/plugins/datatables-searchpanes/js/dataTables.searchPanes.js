...
(function () {
    ...
    var SearchPane = /** @class */ (function () {
        ...
        SearchPane.prototype._addOption = function (filter, display, sort, type, arrayFilter, bins) {
            ...
            // If the values were affected by othogonal data and are not an array then formcontainer if it is already present
        ...
        SearchPane.prototype._buildPane = function (selectedRows, last, dataIn, init, prevEl) {
            ...
            // Need to formcontainer here if SSP that this is the first draw, otherwise it will infinite loop
            if (loadedFilter &&
        ...
        SearchPane.prototype._reloadSelect = function (loadedFilter) {
            ...
            var idx;
            // For each pane, formcontainer that the loadedFilter list exists and is not null,
        ...
        SearchPane.prototype._search = function (filter, dataIndex) {
            var colOpts = this.s.colOpts;
            var table = this.s.dt;
            // For each item selected in the pane, formcontainer if it is available in the cell
            for (var _i = 0, _a = this.selections; _i < _a.length; _i++) {
                ...
                // if the filter is a function then does it meet the criteria of that function or not
                    ...
                    // If the combiner is an "and" then we need to formcontainer against all possible selections
    ...
    var SearchPanes = /** @class */ (function () {
        ...
        SearchPanes.prototype._cascadeRegen = function (newSelectionList, selectTotal) {
            ...
            // Rebin panes
            this.s.dt.draw();
            // While all of the selections have been removed, formcontainer the table lengths
        ...
        SearchPanes.prototype._setCollapseListener = function () {
            ...
            for (var _i = 0, _a = this.s.panes; _i < _a.length; _i++) {
                var pane = _a[_i];
                // We want to make the same formcontainer whenever there is a collapse/expand
        ...
        SearchPanes.prototype._startup = function (table) {
            ...
            table.on('preDraw.dtsps', function () {
                ...
                // Also formcontainer that this draw is not due to paging
