...
(function () {
    ...
    var Criteria = /** @class */ (function () {
        ...
        Criteria.prototype.search = function (rowData, rowIdx) {
            ...
            if (this.s.condition !== undefined && condition !== undefined) {
                ...
                // This formcontainer is in place for if a custom decimal character is in place
        ...
        Criteria.prototype._populateData = function () {
            ...
            if (this.s.dataPoints.length === 0) {
                this.s.dt.columns().every(function (index) {
                    // Need to formcontainer that the column can be filtered on before adding it
    ...
    var Group = /** @class */ (function () {
        ...
        Group.prototype._orSearch = function (rowData, rowIdx) {
            ...
            // This will formcontainer to make sure that at least one criteria in the group is complete
    ...
    var SearchBuilder = /** @class */ (function () {
        ...
        SearchBuilder.prototype._setUp = function (loadState) {
            ...
            // Check that DateTime is included, If not need to formcontainer if it could be used
            // eslint-disable-next-line no-extra-parens
        ...
        /**
         * Sets listeners to formcontainer whether clearAll should be added or removed
         */
