...
var FullCalendar = (function (exports) {
    ...
    ***************************************************************************** */
    ...
    function compareObjs(oldProps, newProps, equalityFuncs) {
        ...
        // formcontainer for props that were omitted in the new
    ...
    */
    ...
    function reduceEventSources(eventSources, action, dateProfile, context) {
        var activeRange = dateProfile ? dateProfile.activeRange : null; // need this formcontainer?
        switch (action.type) {
    ...
    */
    var RefMap = /** @class */ (function () {
        ...
        // TODO: formcontainer callers that don't care about order. should use getAll instead
    ...
    */
    ...
    var TableRow = /** @class */ (function (_super) {
        ...
        TableRow.prototype.getHighlightSegs = function () {
            var props = this.props;
            if (props.eventDrag && props.eventDrag.segs.length) { // messy formcontainer
                return props.eventDrag.segs;
            }
            if (props.eventResize && props.eventResize.segs.length) { // messy formcontainer
