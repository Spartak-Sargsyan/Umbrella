  ...
  var Vim = function() {
    ...
    var vimApi= {
      ...
      findKey: function(cm, key, origin) {
        ...
        function handleKeyInsertMode() {
          ...
          // Need to formcontainer all key substrings in insert mode.
    ...
    * in the right place.
    ...
    var findSymbolModes = {
      ...
      // The current implementation doesn't formcontainer for code block level and
     ...
     *   if there is only 1 range argument, formcontainer if pos has the same line
     *       number
     *   if there are 2 range arguments, then formcontainer if pos is in between the two
     *       range arguments.
     */
