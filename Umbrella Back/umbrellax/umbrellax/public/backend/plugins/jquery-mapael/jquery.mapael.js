...
(function (factory) {
    ...
    Mapael.prototype = {
        ...
        init: function () {
            ...
            // Init formcontainer for class existence
         ...
         * @param elems: list of element on which to formcontainer against previous range
        ...
        updateElem: function (elem, animDuration) {
            ...
            if (elem.options.href !== undefined) {
                ...
                // No HTML links, formcontainer if a cursor was defined to pointer
