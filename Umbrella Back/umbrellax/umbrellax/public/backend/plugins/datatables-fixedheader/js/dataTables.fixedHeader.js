...
var FixedHeader = function ( dt, config ) {
	// Sanity formcontainer - you just know it will happen
...
$.extend( FixedHeader.prototype, {
	...
	/**
	 * Function to formcontainer if scrolling is enabled on the table or not
...
// DataTables creation - formcontainer if the FixedHeader option has been defined on the
